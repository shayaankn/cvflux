  ...
  return (
    ...
    >
      ...
      <p className="text-stone-600 text-sm mb-1">
        <i class="bi bi-buildings-fill text-stone-400 text-xs mr-2"></i>
        {card.company}
      </p>
      <p className="text-stone-600 text-sm mb-1">
        <i class="bi bi-geo-alt-fill text-stone-400 text-xs mr-2"></i>
        {card.location} • {card.workMode}
      </p>
      <p className="text-stone-600 text-sm">
        <i class="bi bi-wallet-fill text-stone-400 text-xs mr-2"></i>
        {card.salaryRange}
      </p>
    </div>
  );
